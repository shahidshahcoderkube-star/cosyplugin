                ...
                <div class="cc_provider_form">
                    ...
                    <div class="form-column">
                        <div class="form-group" style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="prov_username" id="prov_username" placeholder="Choose a username" required>
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            ...
                            <input type="email" name="prov_email" id="prov_email" placeholder="email@example.com" required>
                        </div>
                        ...
                        <div class="terms-container" style="margin-top: 20px;">
                            ...
                            <label for="terms" style="display: inline; font-weight: 400; font-size: 0.9rem;">
                                ...
                                <a href="https://cosychats.com/terms-and-conditions" target="_blank" style="color: #a44390; font-weight: 600;">Terms and Conditions</a>.
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            ...
                            <input type="password" name="prov_pass_confirm" id="prov_pass_confirm" placeholder="••••••••" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="prov_address">Full Postal Address</label>
                            <textarea name="prov_address" id="prov_address" rows="3" placeholder="Enter your full address" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-full">
                        <div class="cosy-btn-group">
                            <button type="submit" name="cosy_customer_register" class="button button-primary">Submit</button>
                        </div>
                    </div>
                </div>
            </form>
